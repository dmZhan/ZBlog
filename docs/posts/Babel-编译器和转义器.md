...
定义： 编译的定义就是从一种编程语言转成另一种编程语言。主要指的是高级语言到低级语言。
...
[![编译流程](/Babel/babel-byqhzyq-1.awebp "编译流程")](https://baidu.com)
...
[![Parse](/Babel/babel-byqhzyq-2.awebp "Parse")](https://baidu.com)
...
[![Transform](/Babel/babel-byqhzyq-3.awebp "Transform")](https://baidu.com)
...
[![Transform](/Babel/babel-byqhzyq-4.awebp "Transform")](https://baidu.com)
